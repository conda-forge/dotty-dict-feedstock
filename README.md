...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dotty-dict-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12149&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dotty-dict-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dotty-dict` can be installed with:

```
conda install dotty-dict
```

It is possible to list all of the versions of `dotty-dict` available on your platform with:
